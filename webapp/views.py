...
# Initialize Firebase app (ensure the path to your service account key is correct)cred = credentials.Certificate(os.path.join(os.path.dirname(__file__), 'static', 'extras', 'firebase_key.json'))
